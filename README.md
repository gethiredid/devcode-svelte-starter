# Devcode Starter using Svelte Level 4
...
1. Selesaikan semua TODO yang terdapat pada file `services/index.js`, `components/ContactItem.svelte`, `components/InputContactForm.svelte`, `routes/contacts/+page.svelte`
